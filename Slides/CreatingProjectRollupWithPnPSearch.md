...
# Building a Project Rollup using PnP Search Web Parts

Thank you for attending my session on Creating a Project Rollup  using PnP Search Web Parts. I hope you enjoyed the session. Here is a list of the resources that were referenced in the session.

## Source Code

- [Source Code](https://symp.info/ProjectRollup)

## Community Resources

- [PnP Modern Search Web Parts](https://symp.info/PnPModernSearch)
