...
function getUserToken(context, settings, magicCode) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (userTokenClient) {
            ...
            return extendedUserTokenProvider.data.getUserToken(context, settings.connectionName, magicCode, settings.oAuthAppCredentials);
        }
        else {
...
function getSignInResource(context, settings) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (userTokenClient) {
            ...
            return extendedUserTokenProvider.data.getSignInResource(context, settings.connectionName, (_b = (_a = context.activity) === null || _a === void 0 ? void 0 : _a.from) === null || _b === void 0 ? void 0 : _b.id, undefined, settings.oAuthAppCredentials);
        }
        else {
            throw new Error('OAuth prompt is not supported by the current adapter');
        }
...
function signOutUser(context, settings) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (userTokenClient) {
            ...
            yield extendedUserTokenProvider.data.signOutUser(context, settings.connectionName, (_e = (_d = context.activity) === null || _d === void 0 ? void 0 : _d.from) === null || _e === void 0 ? void 0 : _e.id, settings.oAuthAppCredentials);
        }
        else {
            throw new Error('OAuth prompt is not supported by the current adapter');
        }
...
function exchangeToken(context, settings, tokenExchangeRequest) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (userTokenClient) {
            ...
            return extendedUserTokenProvider.data.exchangeToken(context, settings.connectionName, (_e = (_d = context.activity) === null || _d === void 0 ? void 0 : _d.from) === null || _e === void 0 ? void 0 : _e.id, tokenExchangeRequest);
        }
        else {
            throw new Error('OAuth prompt is not supported by the current adapter');
        }
