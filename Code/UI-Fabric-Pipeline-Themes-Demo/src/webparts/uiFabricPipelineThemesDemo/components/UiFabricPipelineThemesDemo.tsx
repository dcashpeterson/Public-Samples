...
import styles from './UiFabricPipelineThemesDemo.module.scss';
import { IUiFabricPipelineThemesDemoProps } from './IUiFabricPipelineThemesDemoProps';
import { escape } from '@microsoft/sp-lodash-subset';
import { Opportunity } from '../models/IOpportunity';
import { Logger, ConsoleListener, LogLevel } from '@pnp/logging';


export interface IUiFabricPipelineThemeDemoState {
  opportunities: Opportunity[];
}
export class UiFabricPipelineThemeDemoState implements IUiFabricPipelineThemeDemoState {
  constructor(
    public opportunities: Opportunity[] = []
  ) { }
}

export default class UiFabricPipelineThemesDemo extends React.Component<IUiFabricPipelineThemesDemoProps, IUiFabricPipelineThemeDemoState, {}> {
  constructor(props: IUiFabricPipelineThemesDemoProps) {
    super(props);
    this.state = new UiFabricPipelineThemeDemoState(
  ...
  public render(): React.ReactElement<IUiFabricPipelineThemesDemoProps> {
    return (
      <div className={styles.uiFabricPipelineThemesDemo}>
        <h2>Pipeline</h2>
