...
var DynamicDataWidget_module_scss_1 = tslib_1.__importDefault(require("../DynamicDataWidget.module.scss"));
var DynamicDataWidgetEntry_1 = tslib_1.__importDefault(require("../dynamicDataWidgetEntry/DynamicDataWidgetEntry"));
var DynamicDataWidgetProperty = /** @class */ (function (_super) {
    ...
    DynamicDataWidgetProperty.prototype._renderPropertyDropdown = function () {
        ...
        return (React.createElement(Dropdown_1.Dropdown, { label: sp_core_library_1.Text.format(Strings_resx_1.default.DynamicDataPropertiesDropdownLabel, this.props.selectedSource.metadata.title), onChanged: this._setSelectedPropertyId, options: this._getPropertyDropdownOptions(), selectedKey: selectedPropertyId, "data-automation-id": 'DynamicDataWidgetSourceProperties' }));
    };
        ...
        this.props.entries.forEach(function (entry) {
            ...
            widgetEntries.push(React.createElement("div", { key: currentKey },
                _this.state.selectedPropertyId &&
                    ...
                    propertyValueDepth !== 0 && React.createElement(office_ui_fabric_react_bundle_1.Label, { className: DynamicDataWidget_module_scss_1.default.entryLabel }, label),
                React.createElement(DynamicDataWidgetEntry_1.default, tslib_1.__assign({}, entry, { parentKey: currentKey, selectedSource: _this.props.selectedSource, selectedPropertyText: _this._selectedPropertyText, selectedPropertyId: _this.state.selectedPropertyId, dynamicDataProvider: _this.props.dynamicDataProvider, onChange: _this.props.onChange, propertyValueDepth: propertyValueDepth }))));
        });
    ...
    DynamicDataWidgetProperty.prototype._getPropertyIdFilter = function (selectedSource) {
        ...
        if (this.props.type === IPropertyPaneField_1.PropertyPaneFieldType.DynamicField) {
...
exports.default = DynamicDataWidgetProperty;
