...
var DynamicDataWidgetEntry = /** @class */ (function (_super) {
    ...
    DynamicDataWidgetEntry.prototype._getDropdownForSubProperty = function (level, propertyPath, selectedKey) {
        ...
        selectedKey = selectedKey && selectedKey.split(sp_component_base_1.DynamicDataProvider._jsonPathArrayRegex)[0];
        ...
        var selectedText = level === 0
            ...
            : sp_core_library_1.Text.format(Strings_resx_1.default.DynamicDataPropertiesDropdownLabel, this._parentSelectedKey || this.state.selectedSubPropertyText || this._selectedSubPropertyText);
        ...
        var labelTxt = level === 0 ? sp_core_library_1.Text.format(Strings_resx_1.default.DynamicDataPropertiesDropdownLabel, selectedText) : selectedText;
        return (React.createElement("div", { key: key }, options.length > 0 && (React.createElement(Dropdown_1.Dropdown, { label: labelTxt, 
    ...
    DynamicDataWidgetEntry.prototype._getMaxSubPropertyDepth = function () {
        ...
        if (propertyValueDepth !== undefined) {
            if (propertyValueDepth >= 0 && propertyValueDepth < 2) {
                ...
                sp_core_library_1.Log.warn('propertyValueDepth', sp_core_library_1.Text.format(Strings_resx_1.default.InvalidPropertyValueDepthWarning, 'propertyValueDepth', 0, 2));
            }
        }
        return maxDepth;
    };
    ...
    DynamicDataWidgetEntry.prototype._getSubPropertyValueObject = function (propertyPath) {
        ...
        if (typeof subPropertyValueObject === 'object') {
            for (var _i = 0, subPaths_2 = subPaths; _i < subPaths_2.length; _i++) {
                ...
                // If the sub-property is an array type, then the selected key will be of the type
                // <subPropertyName>[*]. Hence extracting the sub property name, accordingly.
                subPath = subPath.split(sp_component_base_1.DynamicDataProvider._jsonPathArrayRegex)[0];
    ...
    DynamicDataWidgetEntry.prototype._getSubPropertyPath = function () {
        ...
        subPropertyPaths.forEach(function (subPropertyPath) {
            // If the sub-property is an array type, then the selected key will be of the type
            // <subPropertyName>[*]. Hence extracting the sub property name, accordingly.
            subPropertyPath = subPropertyPath.split(sp_component_base_1.DynamicDataProvider._jsonPathArrayRegex)[0];
...
exports.default = DynamicDataWidgetEntry;
