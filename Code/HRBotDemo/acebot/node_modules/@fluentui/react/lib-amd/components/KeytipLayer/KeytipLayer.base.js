define(["require", "exports", "tslib", "react", "./KeytipLayer.styles", "../../Keytip", "../../Layer", "../../Utilities", "../../utilities/keytips/KeytipManager", "./KeytipTree", "../../utilities/keytips/KeytipUtils", "../../utilities/keytips/IKeytipTransitionKey", "../../utilities/keytips/KeytipConstants", "@fluentui/react-window-provider", "../../utilities/dom"], function (require, exports, tslib_1, React, KeytipLayer_styles_1, Keytip_1, Layer_1, Utilities_1, KeytipManager_1, KeytipTree_1, KeytipUtils_1, IKeytipTransitionKey_1, KeytipConstants_1, react_window_provider_1, dom_1) {
    ...
    var KeytipLayerBase = /** @class */ (function (_super) {
        ...
        function KeytipLayerBase(props, context) {
            ...
            _this._isKeytipInstanceTargetVisible = function (keySequences, instanceCount) {
                ...
                return matchingElements.length > 1 && instanceCount <= matchingElements.length
                    ? (0, Utilities_1.isElementVisibleAndNotHidden)(matchingElements[instanceCount - 1], win !== null && win !== void 0 ? win : undefined)
                    : instanceCount === 1;
            };
        ...
        KeytipLayerBase.contextType = react_window_provider_1.WindowContext;
