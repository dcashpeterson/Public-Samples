...
class SassTask extends gulp_core_build_1.GulpTask {
    constructor() {
        ...
        this.cleanMatch = ['src/**/*.sass.ts', 'src/**/*.scss.ts'];
    }
    get _postCSSPlugins() {
    ...
    _processFile(filePath) {
        ...
        const cssModules = new CSSModules_1.default(this.buildConfig.rootPath, this.taskConfig.generateScopedName);
        ...
        return node_core_library_1.LegacyAdapters.convertCallbackToPromise(sass.render, {
            ...
            if (this.taskConfig.cleanCssOptions) {
                cleanCssOptions = Object.assign(Object.assign({}, this.taskConfig.cleanCssOptions), { returnPromise: true });
            }
            ...
            if (cssOutputPathAbsolute) {
                const generatedFileLines = [result.styles.toString()];
                ...
                node_core_library_1.FileSystem.writeFile(cssOutputPathAbsolute, generatedFileLines.join(os_1.EOL), {
            ...
            if (cssOutputPathAbsolute) {
                ...
                lines = lines.concat([
                    ...
                    stylesExportString,
                    '',
                    `loadStyles(${JSON.stringify((0, load_themed_styles_1.splitStyles)(content))});`
                ]);
            }
    ...
    _getStylesExportString(classMap) {
        ...
        return ['const styles = {', styleLines.join(`,${os_1.EOL}`), '};', '', exportString].join(os_1.EOL);
    }
}
