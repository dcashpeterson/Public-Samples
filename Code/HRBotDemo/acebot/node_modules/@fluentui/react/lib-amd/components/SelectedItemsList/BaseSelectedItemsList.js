define(["require", "exports", "tslib", "react", "../../Selection", "../../Utilities", "@fluentui/react-window-provider", "../../utilities/dom"], function (require, exports, tslib_1, React, Selection_1, Utilities_1, react_window_provider_1, dom_1) {
    "use strict";
    ...
    var BaseSelectedItemsList = /** @class */ (function (_super) {
        ...
        BaseSelectedItemsList.prototype.copyItems = function (items) {
            if (this.props.onCopyItems) {
                ...
                var doc = (0, dom_1.getDocumentEx)(this.context); // equivalent to previous behavior of directly using `document`
        ...
        BaseSelectedItemsList.contextType = react_window_provider_1.WindowContext;
