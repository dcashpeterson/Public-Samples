...
var PageContextDataSource = /** @class */ (function () {
    function PageContextDataSource(serviceScope) {
        ...
        this._serviceScope.whenFinished(function () {
            ...
            _this._dynamicDataManager.addSource({
                ...
                metadata: {
                    title: Strings_resx_1.default.pageContextDataSourceTitle,
                    description: Strings_resx_1.default.pageContextDataSourceDescription,
    ...
    PageContextDataSource.prototype.getPropertyDefinitions = function () {
        ...
        return (0, sp_lodash_subset_1.cloneDeep)(retVal);
    };
    /**
    ...
    PageContextDataSource.prototype.getPropertyValue = function (propertyId) {
        if (this._propertyDefinitions[propertyId]) {
            ...
            return (0, sp_lodash_subset_1.cloneDeep)(this._propertyDefinitions[propertyId].propertyValueFunction(propertyId));
        }
        return undefined;
    };
    /**
    ...
    PageContextDataSource.prototype.getAnnotatedPropertyValue = function (propertyId) {
        if (this._propertyDefinitions[propertyId]) {
            ...
            return (0, sp_lodash_subset_1.cloneDeep)(this._propertyDefinitions[propertyId].annotatedPropertyValueFunction(propertyId));
        }
        else {
    ...
    PageContextDataSource.prototype.allowedEventsAsync = function () {
        ...
        return Promise.resolve((0, sp_lodash_subset_1.cloneDeep)(retVal));
    };
    /**
